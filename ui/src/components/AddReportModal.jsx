          ...
          >
            <div>
              ...
              <p style={{ margin: "3px 0 0", fontSize: 13, color: mute }}>
                ZIP files auto-extract test data — manual fields are optional
                fallbacks
              </p>
            </div>
            <button
            ...
            >
              <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                ...
                <datalist id="modal-projects">
                  {projects.map((p, i) => (
                    <option key={i} value={Object.values(p)[0]} />
                  ))}
                </datalist>
              </div>
              <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                ...
                <datalist id="modal-types">
                  {types.map((t, i) => (
                    <option key={i} value={Object.values(t)[0]} />
                  ))}
                </datalist>
              </div>
            </div>
            ...
            >
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                ...
                <div style={{ display: "flex", gap: 6, height: 41 }}>
                  {[
                    { val: "0", label: "✓ Success", color: "#22c55e" },
                    { val: "1", label: "✗ Failed", color: "#ef4444" },
                  ].map((opt) => (
                    <button
                      key={opt.val}
                      type="button"
                      onClick={() =>
                        setPipelineStatus((p) => (p === opt.val ? "" : opt.val))
                      }
                      style={{
                        flex: 1,
                        borderRadius: 10,
                        ...
                        border: `1px solid`,
                        borderColor:
                          pipelineStatus === opt.val ? opt.color : inputBdr,
                        background:
                          pipelineStatus === opt.val
                            ? `${opt.color}22`
                            : inputB,
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <input
                    ...
                    type="text"
                    value={pipelineUrl}
                    placeholder="https://ci.example.com/jobs/123"
              ...
              >
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <input
                    ...
                    value={pipelineOrder}
                    placeholder="42"
                    onChange={(e) => setPipelineOrder(e.target.value)}
                    disabled={loading}
                  />
                </div>
              </div>
